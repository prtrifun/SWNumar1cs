              ...
              children: [
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('${'height'.tr()}: ${provider.person.height}'),
                      const SizedBox(height: 8),
                      Text('${'mass'.tr()}: ${provider.person.mass}'),
                      const SizedBox(height: 8),
                      Text('${'hair_color'.tr()}: ${provider.person.hairColor}'),
                      const SizedBox(height: 8),
                      Text('${'skin_color'.tr()}: ${provider.person.skinColor}'),
                      const SizedBox(height: 8),
                      Text('${'eye_color'.tr()}: ${provider.person.eyeColor}'),
                      const SizedBox(height: 8),
                      Text('${'birth_year'.tr()}: ${provider.person.birthYear}'),
                      const SizedBox(height: 8),
                      Text('${'gender'.tr()}: ${provider.person.gender}'),
                      const SizedBox(height: 8),
                      Text('${'homeworld'.tr()}: ${provider.planet?.name ?? ''}'),
                    ],
                  ),
                ),
                ExpansionTile(
